    ...
    <div ref={containerRef} className="min-h-screen relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              ...
              intelligence to create a self-sustaining orbital ecosystem. We
              capture and recycle space debris while producing breakthrough
              pharmaceuticals and materials in microgravity—building the
              foundation for humanity's permanent presence in space.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              Combining robotic recycling with biological innovation to
              transform orbital operations
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-base md:text-lg text-muted-foreground mb-8 leading-relaxed">
                  Advanced autonomous systems capture and process space debris,
                  converting it into raw materials for 3D manufacturing. Our
                  robotic platforms extend satellite lifespans through on-orbit
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-base md:text-lg text-muted-foreground mb-8 leading-relaxed">
                  Harness microgravity's unique properties for breakthrough
                  pharmaceutical production. Our orbital labs grow ultra-pure
                  protein crystals and manufacture next-generation medicines
      ...
      <section className="py-32 px-6 scroll-fade">
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
              Join the Orbital Revolution
            </h2>
            <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
              Be part of building a sustainable future in space. Whether you're
              an investor, operator, or innovator—let's shape the orbital
              economy together.
            </p>
